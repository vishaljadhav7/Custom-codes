...
if (!Function.prototype.call) {
  Function.prototype.call = function (context, ...args) {
    context = context || globalThis; // Use globalThis for a standard reference to the global object
    const func = this;
    const uniqueProp = Symbol('func');
    context[uniqueProp] = func;
    const result = contextuniqueProp;
...
if (!Function.prototype.bind) {
  Function.prototype.bind = function (context, ...bindArgs) {
    ...
    return function (...args) {
      return func.call(context, ...bindArgs, ...args);
    };
  };
}
